 ...
 * (case-insensitive), so `[[How Clinton-OS works]]` resolves regardless of folder.
...
export const STARTER_NOTES: ReadonlyArray<{ path: string; body: string }> = [
  {
    ...
    body: `# Welcome to Clinton-OS 👋

Clinton-OS is your **local-first second brain** — notes that live as plain Markdown files on your own computer.
...
Most tools give you one of these. Clinton-OS is the bridge between all three.

## Start here

- 🧭 [[Map of Content]] — a hand-made index of everything in this vault.
- 🚀 [[How Clinton-OS works]] — a two-minute tour of the essentials.
...
`,
  ...
  // ── Getting Started ───────────────────────────────────────────────────────
  {
    path: "Getting Started/How Clinton-OS works.md",
    body: `# How Clinton-OS works
...
Clinton-OS speaks **MCP**, so an assistant like Claude can work in your vault directly — see [[Working with your AI]].
...
That's the core move behind [[Wikilinks and backlinks]]. Back to [[How Clinton-OS works]].
`,
  },
  {
...
Clinton-OS exposes your vault over **MCP**, so an assistant like **Claude** (in Claude Desktop or Cowork) can read and write these notes directly.
...
Good first tasks: turn your [[Ideas inbox]] into [[Atomic notes]], or draft a [[Weekly review]]. Back to [[How Clinton-OS works]].
`,
  },
  {
...
Try it on [[Meeting notes]] or a [[Website launch]] plan. Your AI joins the same way — see [[Working with your AI]]. Back to [[How Clinton-OS works]].
`,
  },
...
Syncing is additive, not a dependency: turn it on for [[Collaborating with your team]], turn it off and everything still works. This is the foundation the rest of [[How Clinton-OS works]] builds on.
`,
  },
  {

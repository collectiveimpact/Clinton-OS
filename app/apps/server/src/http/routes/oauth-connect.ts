...
import { GLYPH_FAVICON_DATA_URI } from "../../brand-assets.js";
 ...
 * Clinton-OS logos (embedded, see brand-assets.ts).
 */
...
/** Shared chrome: dark, premium, matches the Clinton-OS brand (black + chrome). */
...
<body>
  <div class="card">
    <span class="wordmark" style="font-family:Poppins,-apple-system,sans-serif;font-weight:700;font-size:28px;letter-spacing:-0.03em;color:#EDEDF0">${esc(BRAND_NAME)}<span aria-hidden="true" style="display:inline-block;width:8px;height:8px;margin-left:6px;border-radius:999px;background:#00B6B2;vertical-align:middle"></span></span>
    ${opts.body}
  </div>
</body>
</html>`;

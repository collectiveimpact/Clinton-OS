> **Clinton-OS** is a fork of [Baalda](https://github.com/naveedharri/baalda) (Apache 2.0) rebranded for Business Solutions and Fuse5 under docs/BRANDING.md Layer 1. Baalda is a trademark of its owner and is not used as this fork's name. Deploy kit for AWS ca-central-1 lives in `deploy/aws-ca-central-1/`. Fork date 2026-09-04, upstream commit 8e261b3.
